---
layout: 'redirect'
redir_to: 'https://www.slembcke.net/blog/WaterWaves/'
...
new Widget("wavies", widget => {
	...
	function interact_waves(mvel, waves){
		...
		for(let i = x0; i < x1; i++){
			...
			const damp = 1 - Math.exp(20e-2*mag/gauss);
...
A fluid simulation using the FLIP algorithm from the 10 Minute Physics [blog](https://matthias-research.github.io/pages/tenMinutePhysics/index.html)
{: style="text-align: center"}
